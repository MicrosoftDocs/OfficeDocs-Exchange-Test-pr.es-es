---
title: 'Rol Mensajería unificada: Exchange 2013 Help'
TOCTitle: Rol Mensajería unificada
ms:assetid: bf24aa04-5843-4cf3-83e7-3a5fa7bd3522
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876935(v=EXCHG.150)
ms:contentKeyID: 49895883
ms.date: 05/22/2018
...
La función de `Unified Messaging` permite que los administradores gestionen los servidores de mensajería unificada (MU) de una organización.

Esta función no lo habilita a administrar la configuración de buzones específicos de mensajería unificada o mensajes de mensajería unificada. Para administrar una configuración de buzón de Mensajería unificada específica, use las funciones asociadas con la función `UM Mailboxes `. Para administrar los mensajes de Mensajería unificada, utilice las funciones asociadas a la función `UM Prompts`. Para obtener más información, vea:
