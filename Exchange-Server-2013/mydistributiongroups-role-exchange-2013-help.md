---
title: 'Rol MyDistributionGroups: Exchange 2013 Help'
TOCTitle: Rol MyDistributionGroups
ms:assetid: 0d23dec0-3832-43bb-bc89-e01408acd0e8
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876849(v=EXCHG.150)
ms:contentKeyID: 49895456
ms.date: 04/23/2018
...
La función de administración `MyDistributionGroups` permite a los usuarios individuales crear, modificar y ver grupos de distribución, y modificar, ver, quitar y agregar miembros a grupos de distribución de los que son propietarios.
