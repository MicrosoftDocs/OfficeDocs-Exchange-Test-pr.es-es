---
title: 'Rol Registro en diario: Exchange 2013 Help'
TOCTitle: Rol Registro en diario
ms:assetid: 64608dbe-d4b4-444e-a7df-bc536c4da202
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876894(v=EXCHG.150)
ms:contentKeyID: 49895672
ms.date: 05/22/2018
...
La función de administración `Journaling` permite que los administradores creen, modifiquen, habiliten, deshabiliten, vean y quiten reglas de diario de una organización.
