---
title: 'Rol Registros de auditoría: Exchange 2013 Help'
TOCTitle: Rol Registros de auditoría
ms:assetid: 36a7d375-76f8-441c-9da1-8a50dbd062f1
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876870(v=EXCHG.150)
ms:contentKeyID: 49895566
ms.date: 04/23/2018
...
La función de administración `Audit Logs` permite a los administradores configurar el registro de auditoría de administrador en una organización.
