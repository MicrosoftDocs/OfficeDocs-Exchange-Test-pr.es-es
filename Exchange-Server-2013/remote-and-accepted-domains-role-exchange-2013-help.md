---
title: 'Rol Dominios remotos y aceptados: Exchange 2013 Help'
TOCTitle: Rol Dominios remotos y aceptados
ms:assetid: 340c7546-5236-4743-a2b3-3c2363f3da1d
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876869(v=EXCHG.150)
ms:contentKeyID: 49895562
ms.date: 05/22/2018
...
La función de administración `Remote and Accepted Domains` permite a los administradores administrar dominios remotos y aceptados en una organización.
