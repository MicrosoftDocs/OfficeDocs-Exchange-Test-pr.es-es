---
title: 'Rol Agentes de transporte: Exchange 2013 Help'
TOCTitle: Rol Agentes de transporte
ms:assetid: 1679402e-158f-4630-8ef1-01ab5c7ce811
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876853(v=EXCHG.150)
ms:contentKeyID: 49895491
ms.date: 05/22/2018
...
La función de administración `Transport Agents` permite que los administradores se encarguen de los agentes de transporte de una organización.
