---
title: 'Rol MyTextMessaging: Exchange 2013 Help'
TOCTitle: Rol MyTextMessaging
ms:assetid: 0e030bdb-8a72-4925-bb77-eaca249c36fc
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Ee633454(v=EXCHG.150)
ms:contentKeyID: 49895466
ms.date: 05/22/2018
...
La función de administración de `MyTextMessaging` permite que los usuarios individuales creen, vean y modifiquen las configuraciones de sus mensajes de texto.
...
<tbody>
<tr class="odd">
<td><p>Directiva de asignación de funciones predeterminada</p>
