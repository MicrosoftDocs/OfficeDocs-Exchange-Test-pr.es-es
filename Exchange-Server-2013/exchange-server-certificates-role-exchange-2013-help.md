---
title: 'Rol Certificados del servidor de Exchange: Exchange 2013 Help'
TOCTitle: Rol Certificados del servidor de Exchange
ms:assetid: fffec840-6c7d-4958-905e-edc4bc060d52
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876963(v=EXCHG.150)
ms:contentKeyID: 49896046
ms.date: 05/22/2018
...
La función de administración `Exchange Server Certificates` permite que los administradores creen, importen, exporten y administren certificado de servidor Exchange de determinados servidores.
