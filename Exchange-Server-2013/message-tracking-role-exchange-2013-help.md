---
title: 'Rol Seguimiento de mensajes: Exchange 2013 Help'
TOCTitle: Rol Seguimiento de mensajes
ms:assetid: 21f18ccd-9b7d-461b-b77c-443d15696d79
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876858(v=EXCHG.150)
ms:contentKeyID: 49895514
ms.date: 04/23/2018
...
La función de administración `Message Tracking` permite a los administradores realizar el seguimiento de los mensajes de una organización.
