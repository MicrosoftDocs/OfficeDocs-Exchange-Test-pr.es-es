---
title: 'Rol Destinatarios con permiso de vista: Exchange 2013 Help'
TOCTitle: Rol Destinatarios con permiso de vista
ms:assetid: 37e66b92-81d3-412f-b7a9-e1bb8cbeb468
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876872(v=EXCHG.150)
ms:contentKeyID: 49895570
ms.date: 05/22/2018
...
La función de administración `View-Only Recipients` permite a los administradores ver la configuración de los destinatarios, como buzones, usuarios de correo, contactos de correo, grupos de distribución y grupos de distribución dinámicos.

Esta función se puede combinar con funciones asociadas a la función `View-Only Configuration` para crear un grupo de funciones que pueda ver todos los objetos en la organización. Para obtener más información, consulte [Rol Configuración con permiso de vista](view-only-configuration-role-exchange-2013-help.md).
