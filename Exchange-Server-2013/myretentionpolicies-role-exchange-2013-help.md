---
title: 'Rol MyRetentionPolicies: Exchange 2013 Help'
TOCTitle: Rol MyRetentionPolicies
ms:assetid: 65f49d19-cfb5-4142-8359-8368d5c48085
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876897(v=EXCHG.150)
ms:contentKeyID: 49895676
ms.date: 05/22/2018
...
La función de administración `MyRetentionPolicies` permite que los usuarios individuales puedan tener acceso a sus etiquetas de retención, además de ver y modificar la configuración y la predeterminación de dichas etiquetas.
