...
_**Última modificación del tema:**2018-04-19_
...
![Esquema de la arquitectura de autenticación moderna híbrida en Outlook para iOS y Android](images/Mt846639.20a7e963-916d-47e0-bffb-4d86c4777bea(EXCHG.150).png "Esquema de la arquitectura de autenticación moderna híbrida en Outlook para iOS y Android")
...
![Flujo de autenticación de la autenticación moderna híbrida](images/Mt846639.d6e20ddb-cf8e-4154-8a17-95657ef696d1(EXCHG.150).png "Flujo de autenticación de la autenticación moderna híbrida")
...
![Ejemplo de una cuenta de Outlook para iOS y Android configurada para la autenticación moderna híbrida](images/Mt846639.79887a65-e5e1-4501-a274-008393dbb6c9(EXCHG.150).png "Ejemplo de una cuenta de Outlook para iOS y Android configurada para la autenticación moderna híbrida")
