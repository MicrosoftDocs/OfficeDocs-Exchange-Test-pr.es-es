---
title: 'Rol Pertenencia y Creación de grupos de seguridad: Exchange 2013 Help'
TOCTitle: Rol Pertenencia y Creación de grupos de seguridad
ms:assetid: 257eb517-339f-4895-9e08-f772408a41cf
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876860(v=EXCHG.150)
ms:contentKeyID: 49895522
ms.date: 04/23/2018
...
La función de administración de `Security Group Creation and Membership` permite que los administradores creen y administren grupos de seguridad universal (USG) y la suscripción en una organización.
...
Si su organización ha habilitado permisos divididos Active Directory, se quitaron todas las asignaciones de roles de administración sin delegación a este rol de administración. Si los permisos divididos de Active Directory están habilitados, solo los administradores de Active Directory que usan herramientas de administración de Active Directory pueden crear nuevas entidades de seguridad como usuarios y grupos de seguridad.

Para obtener más información, consulte [Descripción de los permisos divididos](understanding-split-permissions-exchange-2013-help.md).
