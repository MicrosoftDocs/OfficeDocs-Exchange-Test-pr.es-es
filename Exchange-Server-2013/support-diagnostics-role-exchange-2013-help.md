---
title: 'Rol Diagnósticos de soporte: Exchange 2013 Help'
TOCTitle: Rol Diagnósticos de soporte
ms:assetid: 3ad2c628-019e-4eb7-af43-64ab2a3a2fbf
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876875(v=EXCHG.150)
ms:contentKeyID: 49895579
ms.date: 05/22/2018
...
La función de administración `Support Diagnostics` permite a los administradores realizar diagnósticos avanzados bajo la dirección del servicio de soporte técnico y atención al cliente de Microsoft en una organización.


> [!WARNING]
> Esta función concede permisos a cmdlets y scripts que solo deben usarse con la dirección del servicio de soporte técnico y atención al cliente.
