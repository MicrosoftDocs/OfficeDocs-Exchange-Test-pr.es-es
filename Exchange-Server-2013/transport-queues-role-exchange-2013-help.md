---
title: 'Rol Colas de transporte: Exchange 2013 Help'
TOCTitle: Rol Colas de transporte
ms:assetid: f663005a-4cb0-4c52-9c95-58681fc5eaab
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876955(v=EXCHG.150)
ms:contentKeyID: 49896017
ms.date: 05/22/2018
...
El rol de administración `Transport Queues` permite que los administradores se encarguen de las colas de mensajes en un servidor de transporte determinado.
