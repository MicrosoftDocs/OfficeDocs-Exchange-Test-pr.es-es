---
title: 'Rol de grupos de distribución: Exchange 2013 Help'
TOCTitle: Rol de grupos de distribución
ms:assetid: 0c3667b6-529b-4bb2-85bf-e24fae82d082
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876848(v=EXCHG.150)
ms:contentKeyID: 49895454
ms.date: 04/23/2018
...
La función de administración `Distribution Groups` permite a los administradores crear, modificar, ver y eliminar grupos de distribución, y agregar o eliminar miembros de grupos de distribución en una organización.
