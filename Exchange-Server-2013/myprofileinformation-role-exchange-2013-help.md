---
title: 'Rol MyProfileInformation: Exchange 2013 Help'
TOCTitle: Rol MyProfileInformation
ms:assetid: 309c3a88-8abe-497d-aa92-30bdc58b9eae
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876865(v=EXCHG.150)
ms:contentKeyID: 49895550
ms.date: 05/22/2018
...
La función de administración de `MyProfileInformation` permite modificar el nombre de los usuarios individuales.
