---
title: 'Rol Agentes de extensión de cmdlet: Exchange 2013 Help'
TOCTitle: Rol Agentes de extensión de cmdlet
ms:assetid: 20f9f7c2-a8e5-468e-b1a8-c87c562a2be7
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876857(v=EXCHG.150)
ms:contentKeyID: 49895511
ms.date: 05/22/2018
...
La función de administración `Cmdlet Extension Agents` permite que los administradores habiliten, deshabiliten y establezcan la prioridad de los agentes de extensión de cmdlet en una organización.
