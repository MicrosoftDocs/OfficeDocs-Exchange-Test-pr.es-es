---
title: 'Rol Importar/Exportar buzón: Exchange 2013 Help'
TOCTitle: Rol Importar/Exportar buzón
ms:assetid: d7cdce7a-6c46-4750-b237-d1c1773e8d28
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Ee633482(v=EXCHG.150)
ms:contentKeyID: 49895947
ms.date: 04/23/2018
...
La función de administración `Mailbox Import Export` permite a los administradores importar y exportar contenido de buzones de correo y purgar el contenido no deseado de un buzón.
