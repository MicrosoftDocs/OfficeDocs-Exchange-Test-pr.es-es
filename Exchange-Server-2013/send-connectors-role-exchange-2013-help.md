---
title: 'Rol Conectores de envío: Exchange 2013 Help'
TOCTitle: Rol Conectores de envío
ms:assetid: 8021e279-2b74-469e-aa6d-d0197f34ba6c
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876913(v=EXCHG.150)
ms:contentKeyID: 49895743
ms.date: 05/22/2018
...
La función de administración `Send Connectors` permite a los administradores administrar conectores de envío de transporte en una organización.
