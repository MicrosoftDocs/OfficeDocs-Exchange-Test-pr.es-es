---
title: 'Rol Acceso de clientes de la organización: Exchange 2013 Help'
TOCTitle: Rol Acceso de clientes de la organización
ms:assetid: ff84799a-b79c-498d-b797-7675a4afb1eb
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876962(v=EXCHG.150)
ms:contentKeyID: 49896045
ms.date: 04/23/2018
...
La función de administración de `Organization Client Access` permite que los administradores se encarguen de la configuración del servidor de acceso de transporte de una organización.
