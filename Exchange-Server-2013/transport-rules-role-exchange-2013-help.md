---
title: 'Rol Reglas de transporte: Exchange 2013 Help'
TOCTitle: Rol Reglas de transporte
ms:assetid: 53c5b1a5-e989-4373-ac70-7db16000c645
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876885(v=EXCHG.150)
ms:contentKeyID: 49895630
ms.date: 05/22/2018
...
La función de administración de `Transport Rules` permite a los administradores administrar las reglas de transporte en una organización.
