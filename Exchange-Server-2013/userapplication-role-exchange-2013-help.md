---
title: 'Rol UserApplication: Exchange 2013 Help'
TOCTitle: Rol UserApplication
ms:assetid: a4621e45-53db-42f7-a5d7-c1900a154b4e
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ657476(v=EXCHG.150)
ms:contentKeyID: 49895811
ms.date: 05/22/2018
...
La función de administración de `UserApplication` permite a las aplicaciones de socios actuar en nombre de los usuarios finales.
