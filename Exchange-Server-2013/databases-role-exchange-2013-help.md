---
title: 'Rol Bases de datos: Exchange 2013 Help'
TOCTitle: Rol Bases de datos
ms:assetid: 317d9945-668b-448e-963f-f7127b9b3d79
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876868(v=EXCHG.150)
ms:contentKeyID: 49895557
ms.date: 05/22/2018
...
El rol de administración `Databases` permite a los administradores crear, administrar, montar y desmontar buzones y bases de datos en servidores individuales.
...
El cmdlet **Move-DatabasePath**, incluido con este rol, necesita que la base de datos que desee configurar se encuentre en el ámbito de la base de datos y esta debe residir en el servidor dentro del ámbito del servidor.

Además, el cmdlet **Remove-MailboxDatabase** que además se incluye con este rol, necesita que la base de datos que desee quitar se encuentre dentro del ámbito de la base de datos o la base de datos debe residir en un servidor que se encuentre dentro del ámbito del servidor. Esto significa que usted controla quién puede quitar bases de datos de buzones de correo mediante el uso de ámbitos de servidores o base de datos.

Para obtener más información, consulte [Descripción de los ámbitos de roles de administración](understanding-management-role-scopes-exchange-2013-help.md).
