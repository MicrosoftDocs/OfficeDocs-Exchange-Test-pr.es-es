---
title: 'Rol Configuración de transporte de la organización: Exchange 2013 Help'
TOCTitle: Rol Configuración de transporte de la organización
ms:assetid: ff4d032e-1b97-4a9d-b479-9b0d61832221
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876961(v=EXCHG.150)
ms:contentKeyID: 49896044
ms.date: 05/22/2018
...
Esta función no permite crear ni administrar conectores de envío o recepción, colas, higiene, agentes, dominios remotos o aceptados, ni reglas. Para crear o administrar las funciones de transporte, se le debe asignar una o más de las funciones siguientes:
