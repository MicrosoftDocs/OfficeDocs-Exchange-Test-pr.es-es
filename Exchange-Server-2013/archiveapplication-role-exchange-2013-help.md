---
title: 'Rol ArchiveApplication: Exchange 2013 Help'
TOCTitle: Rol ArchiveApplication
ms:assetid: 22d673cf-d3a3-43f0-be1e-e4fc74546e64
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ673046(v=EXCHG.150)
ms:contentKeyID: 49895517
ms.date: 05/22/2018
...
El rol de administración de `ArchiveApplication` permite a las aplicaciones asociadas archivar elementos en buzones de correo de asociados.
