---
title: 'Rol Búsqueda entre buzones: Exchange 2013 Help'
TOCTitle: Rol Búsqueda entre buzones
ms:assetid: f86b63ba-0c67-4748-8965-0c08a6a8aec1
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876958(v=EXCHG.150)
ms:contentKeyID: 49896023
ms.date: 04/23/2018
...
La función de administración `Mailbox Search` permite que los administradores busquen el contenido de uno o más buzones de una organización.
