---
title: 'Rol MyVoiceMail: Exchange 2013 Help'
TOCTitle: Rol MyVoiceMail
ms:assetid: 5c7310e9-742c-4bdf-90b6-0a0d17c3bda1
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876890(v=EXCHG.150)
ms:contentKeyID: 49895657
ms.date: 05/22/2018
...
La función de administración de `MyVoiceMail` permite que los usuarios individuales vean y modifiquen las configuraciones de su correo de voz.
