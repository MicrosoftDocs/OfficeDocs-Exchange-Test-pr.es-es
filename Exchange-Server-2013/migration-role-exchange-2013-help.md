---
title: 'Rol de migración: Exchange 2013 Help'
TOCTitle: Rol de migración
ms:assetid: 8b5a3385-7dc0-4492-9f00-a4616982016b
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876920(v=EXCHG.150)
ms:contentKeyID: 49895763
ms.date: 05/22/2018
...
La función de administración `Migration` permite a los administradores migrar buzones y contenido de buzones hacia el servidor y desde el servidor.
