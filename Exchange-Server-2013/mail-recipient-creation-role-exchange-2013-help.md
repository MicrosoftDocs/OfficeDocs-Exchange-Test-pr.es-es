---
title: 'Rol Creación de destinatarios de correo: Exchange 2013 Help'
TOCTitle: Rol Creación de destinatarios de correo
ms:assetid: 81081845-9ebf-4888-8f9f-fe7cf2704486
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876915(v=EXCHG.150)
ms:contentKeyID: 49895744
ms.date: 04/23/2018
...
Esta función no permite habilitar carpetas públicas para correo. Para habilitar carpetas públicas para correo se debe usar la función `Mail Enabled Public Folders`. Para obtener más información, consulte [Rol Carpetas públicas habilitadas para correo](mail-enabled-public-folders-role-exchange-2013-help.md).

Si en su organización se mantiene un modelo de permisos divididos de Control de acceso basado en roles (RBAC) donde un grupo distinto del grupo encargado de administrar destinatarios crea los destinatarios, asigne el rol `Mail Recipient Creation` al grupo de roles de administración que crea los destinatarios; asimismo, asigne el rol `Mail Recipients` al grupo de roles encargado de administrar destinatarios.

Si en su organización se han habilitado los permisos divididos de Active Directory, se eliminaron todas las asignaciones de rol de administración que no sean de delegación. Si los permisos divididos de Active Directory están habilitados, solo los administradores de Active Directory que usan herramientas de administración de Active Directory pueden crear nuevas entidades de seguridad como usuarios y grupos de seguridad.

Para obtener más información acerca de RBAC y los permisos divididos de Active Directory, consulte [Descripción de los permisos divididos](understanding-split-permissions-exchange-2013-help.md).
...
Además de los ámbitos de destinatario, el ámbito del cmdlet **New-Mailbox**, que se incluye con este rol, se determina también con los ámbitos de configuración de base de datos. Los ámbitos de configuración de base de datos controlan en qué bases de datos el cmdlet puede crear nuevos buzones. La base de datos en la que quiere crear un buzón debe encontrarse en el ámbito de bases de datos. Esto se aplica cuando especifica una base de datos utilizando un parámetro *Database* en cmdlet **New-Mailbox** y cuando permite que la distribución de buzón automática seleccione la base de datos. Para obtener más información, consulte [Descripción de los ámbitos de roles de administración](understanding-management-role-scopes-exchange-2013-help.md).
