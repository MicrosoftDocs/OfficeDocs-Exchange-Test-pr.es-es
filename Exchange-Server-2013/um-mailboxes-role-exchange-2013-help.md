---
title: 'Rol Buzones de mensajería unificada: Exchange 2013 Help'
TOCTitle: Rol Buzones de mensajería unificada
ms:assetid: 6c9442dc-e674-4474-888e-e2f391a8eb57
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876901(v=EXCHG.150)
ms:contentKeyID: 49895694
ms.date: 05/22/2018
...
El rol de administración de `UM Mailboxes` permite a los administradores administrar la configuración de mensajería unificada de los buzones y de otros destinatarios de una organización.
