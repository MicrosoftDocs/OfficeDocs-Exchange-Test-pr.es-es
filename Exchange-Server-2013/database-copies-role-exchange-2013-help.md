---
title: 'Rol Copias de base de datos: Exchange 2013 Help'
TOCTitle: Rol Copias de base de datos
ms:assetid: 71a95f5b-1f75-4ae9-9ee9-515c3a19d394
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876905(v=EXCHG.150)
ms:contentKeyID: 49895706
ms.date: 05/22/2018
...
La función de administración `Database Copies` permite que los administradores agreguen, quiten, suspendan, reanuden, vean y actualicen copias de la base de datos en servidores individuales.
...
Los cmdlets **Set-MailboxDatabaseCopy** y **Remove-MailboxDatabaseCopy**, que se incluyen en este rol, requieren que la base de datos que desea configurar o quitar esté dentro del ámbito de la base de datos y la base de datos debe residir en un servidor que esté dentro del ámbito de servidor. Para obtener más información sobre los ámbitos, consulte [Descripción de los ámbitos de roles de administración](understanding-management-role-scopes-exchange-2013-help.md).
