---
title: 'Rol Carpetas públicas: Exchange 2013 Help'
TOCTitle: Rol Carpetas públicas
ms:assetid: b858f04c-ac0b-495f-9193-8b9645781f73
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876930(v=EXCHG.150)
ms:contentKeyID: 49895862
ms.date: 05/22/2018
...
La función de administración de `Public Folders ` permite a los administradores administrar carpetas públicas en una organización.

Esta función no permite administrar carpetas públicas habilitadas para correo. Para habilitar o deshabilitar carpetas públicas, debe tener asignada una función asociada a la función `Mail Enabled Public Folders `. Para obtener más información, consulte [Rol Carpetas públicas habilitadas para correo](mail-enabled-public-folders-role-exchange-2013-help.md).
