---
title: 'Rol Carpetas públicas habilitadas para correo: Exchange 2013 Help'
TOCTitle: Rol Carpetas públicas habilitadas para correo
ms:assetid: 22289ae1-f9e8-4c98-aaad-ee623e05eadd
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876859(v=EXCHG.150)
ms:contentKeyID: 49895515
ms.date: 05/22/2018
...
Esta función solamente permite administrar las propiedades de correo electrónico de las carpetas públicas. No le permite administrar las propiedades de las carpetas públicas que no están relacionadas con el correo electrónico. Para administrar las propiedades de la carpeta pública que no están relacionadas con el correo electrónico, use la función `Public Folders`. Para obtener más información, consulte [Rol Carpetas públicas](public-folders-role-exchange-2013-help.md).
