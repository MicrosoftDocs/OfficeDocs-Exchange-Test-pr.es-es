---
title: 'Rol Aplicaciones personalizadas de la organización: Exchange 2013 Help'
TOCTitle: Rol Aplicaciones personalizadas de la organización
ms:assetid: ab2aac13-f783-43e6-a369-75cce1d4943f
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ657482(v=EXCHG.150)
ms:contentKeyID: 49895829
ms.date: 05/22/2018
...
El rol de administración Org Custom Apps permite a los administradores ver y modificar sus aplicaciones de la organización y agregar aplicaciones personalizadas desde un archivo o dirección URL.
