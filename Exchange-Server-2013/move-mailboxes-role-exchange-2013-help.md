---
title: 'Rol Mover buzones: Exchange 2013 Help'
TOCTitle: Rol Mover buzones
ms:assetid: 46576498-5d73-495b-8925-b8ce39cfa55e
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876879(v=EXCHG.150)
ms:contentKeyID: 49895605
ms.date: 04/23/2018
...
La función de administración `Move Mailboxes` permite que los administradores muevan buzones entre los servidores de una organización y entre los servidores de la organización local y otra organización.
...
Además de los ámbitos de destinatarios, el cmdlet **New-MoveRequest**, incluido con este rol, además tiene un ámbito usado mediante ámbitos de configuración de base de datos. Los ámbitos de la configuración de base de datos controlan las bases de datos hacia las que el cmdlet puede mover los buzones. La base de datos a la que desea mover el buzón de correo se debe encontrar dentro del ámbito de la base de datos. Esta condición se aplica cuando especifica una base de datos mediante el parámetro *TargetDatabase* en el cmdlet **New-MoveRequest** o si permite la distribución de buzones de correo automáticos para seleccionar la base de datos para usted. Para obtener más información, consulte [Descripción de los ámbitos de roles de administración](understanding-management-role-scopes-exchange-2013-help.md).
