---
title: 'Rol Retención legal: Exchange 2013 Help'
TOCTitle: Rol Retención legal
ms:assetid: c98ce8ca-3477-479a-ad23-a8e6459bc4d0
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876939(v=EXCHG.150)
ms:contentKeyID: 49895908
ms.date: 05/22/2018
...
La función de administración `Legal Hold` permite a los administradores configurar si los datos de un buzón deben conservarse en la organización, en caso de litigios.
...
Además de los ámbitos de destinatario, el cmdlet **Enable-Mailbox**, incluido en este rol, se aplica también mediante ámbitos de configuración de bases de datos. Los ámbitos de configuración de bases de datos controlan en qué bases de datos el cmdlet puede crear nuevos buzones. La base de datos en la que desea crear un buzón debe encontrarse dentro del ámbito de la base de datos. Esto se aplica cuando especifica una base de datos utilizando un parámetro *Database* en cmdlet **Enable-Mailbox** y cuando permite que la distribución de buzón automática seleccione la base de datos. Para obtener más información, consulte [Descripción de los ámbitos de roles de administración](understanding-management-role-scopes-exchange-2013-help.md).
