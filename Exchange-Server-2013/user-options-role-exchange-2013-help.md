---
title: 'Rol Opciones de usuario: Exchange 2013 Help'
TOCTitle: Rol Opciones de usuario
ms:assetid: fb4d58f5-cc62-4ce8-b2e4-c3cc91795a12
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876960(v=EXCHG.150)
ms:contentKeyID: 49896029
ms.date: 05/22/2018
...
La función de administración `User Options` permite que los administradores vean las opciones de Outlook Web App de un usuario de una organización. Esta función puede usarse para ayudar a diagnosticar problemas de configuración.
