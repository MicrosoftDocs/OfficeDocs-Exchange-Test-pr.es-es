---
title: 'Rol Registros de auditoría con permiso de vista: Exchange 2013 Help'
TOCTitle: Rol Registros de auditoría con permiso de vista
ms:assetid: 9298fe59-0a16-4a09-bdb8-514d1cea6e2f
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Ff461933(v=EXCHG.150)
ms:contentKeyID: 49895784
ms.date: 05/22/2018
...
La función de administración `View-Only Audit Logs` permite que los administradores y usuarios especialistas busquen los registros de auditoría de administrador en una organización.
