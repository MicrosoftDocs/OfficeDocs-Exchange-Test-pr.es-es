---
title: 'Rol Administración de la retención: Exchange 2013 Help'
TOCTitle: Rol Administración de la retención
ms:assetid: ef16b495-c424-4ded-b5da-304e69ce31bb
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876953(v=EXCHG.150)
ms:contentKeyID: 49896001
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Rol Administración de la retención
...
La función de administración de `Retention Management` permite a los administradores administrar las directivas de retención de una organización.
