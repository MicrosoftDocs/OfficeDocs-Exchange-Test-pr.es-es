---
title: 'Rol Configuración de la organización: Exchange 2013 Help'
TOCTitle: Rol Configuración de la organización
ms:assetid: db952cc5-ef70-4366-acbb-0e292d4cbdd0
ms:mtpsurl: https://technet.microsoft.com/es-es/library/Dd876946(v=EXCHG.150)
ms:contentKeyID: 49895955
ms.date: 04/23/2018
...
La función de administración de `Organization Configuration` permite a los administradores administrar la configuración de toda la organización. Estos son algunos de los aspectos de la configuración de una organización que se pueden controlar mediante esta función:
  ...
  - La dirección URL de la página principal de carpeta administrada

  - La dirección de SMTP de destinatario de Microsoft Exchange y las direcciones de correo electrónico alternativas

  - La configuración del esquema de propiedades del buzón de recursos

  - URL de ayuda para el centro de administración de Exchange y Microsoft OfficeOutlook Web App

Este tipo de función no incluye los permisos incluidos en las funciones de `Organization Client Access` o `Organization Transport Settings`.
