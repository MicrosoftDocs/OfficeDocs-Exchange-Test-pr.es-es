---
title: 'Actualizaciones de cmdlet de mensajería unificada: Exchange 2013 Help'
TOCTitle: Actualizaciones de cmdlet de mensajería unificada
ms:assetid: a42c6643-67ed-4003-854a-ac1d66efb965
ms:mtpsurl: https://technet.microsoft.com/es-es/library/JJ150557(v=EXCHG.150)
ms:contentKeyID: 48268504
ms.date: 05/22/2018
mtps_version: v=EXCHG.150
ms.translationtype: MT
---

# Actualizaciones de cmdlet de mensajería unificada
...
> [!NOTE]
> Este cmdlet solo funciona con los servidores de mensajería unificada de Exchange 2007 y 2010.
...
Para obtener información detallada sobre todos los cmdlets de mensajería unificada, vea [Cmdlets de mensajería unificada](https://technet.microsoft.com/es-es/library/aa997665\(v=exchg.150\)).
